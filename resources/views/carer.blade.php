...
@section('content')
    ...
    <div class="carer-container">
        <div class="carer-left">
            <h3>تکایە فۆڕمەکە پڕبکەرەوە </h3>
            <div class="input-container">
                <span>ناو</span>
                <input type="text" class="carer-input" placeholder="ناو" />
            </div>
            <div class="input-container">
                <span>تەمەن</span>
                <input type="text" class="carer-input" placeholder="تەمەن" />
            </div>
            <div class="input-container">
                <span>ئیمەیڵ</span>
                <input type="text" class="carer-input" placeholder="ئیمەیڵ" />
            </div>
            <div class="input-container">
                <button class="carer-button"> تۆمارکردن</button>
            </div>
        </div>
        <div class="carer-right">
            <div>
                ...
                <div><i class="fa fa-check"> </i> چوارەم- بەشى خوارى خوارەوە، ئەو ستایلەى ئێستاى جوانە بمێنێت، تەنها
                    دوو شتى بۆ زیاد بکرێت، لەبارەى ئێمەوە، پەیوەندی.</div>
                <div><i class="fa fa-check"> </i> چوارەم- بەشى خوارى خوارەوە، ئەو ستایلەى ئێستاى جوانە بمێنێت، تەنها
                    دوو شتى بۆ زیاد بکرێت، لەبارەى ئێمەوە، پەیوەندی.</div>
            </div>
            <img src="{{ asset('image/carer/1.svg')}} " class="carer-image" />
        </div>
    </div>
@endsection